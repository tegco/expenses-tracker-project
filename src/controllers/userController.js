...
const { validateRegister, validateLogin, validateUpdatePassword, validateCreateOrUpdateIncome,
    validateCreateOrUpdateExpense} = require('../middleware/validationMiddleware');
